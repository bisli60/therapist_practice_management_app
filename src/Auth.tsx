...
export function Auth({ onLogin }: AuthProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#fbfbfd] dark:bg-black transition-colors duration-500">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white">מערכת לניהול קליניקה</h1>
          <p className="text-xl text-slate-500 dark:text-slate-400">ניהול מטופלים, תיעוד טיפולים ומעקב הכנסות בחשבון אישי ומאובטח.</p>
        </div>

        <div className="bg-white dark:bg-gray-900 p-8 rounded-container shadow-xl border border-gray-100 dark:border-gray-800">
