...
function Content({ activeTab }: { activeTab: Tab }) {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <Authenticated>
        ...
        {activeTab === "treatments" && <AddSession />}
        {activeTab === "patients" && <PatientList patients={patients} showActions />}
        {activeTab === "reports" && <ReportsPage />}
        {activeTab === "settings" && <SettingsPage />}
      </Authenticated>
      <Unauthenticated>
        <div className="flex flex-col items-center justify-center min-h-[400px] gap-8 mt-12">
          <div className="text-center flex flex-col items-center gap-4">
            ...
            <p className="text-xl text-slate-500 dark:text-slate-400">נהל את כספי הקליניקה שלך בקלות</p>
          </div>
          <SignInForm />
        </div>
      </Unauthenticated>
